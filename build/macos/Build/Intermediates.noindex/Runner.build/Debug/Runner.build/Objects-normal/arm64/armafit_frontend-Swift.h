...
#ifndef ARMAFIT_FRONTEND_SWIFT_H
#define ARMAFIT_FRONTEND_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="armafit_frontend",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC16armafit_frontend11AppDelegate")
...
SWIFT_CLASS("_TtC16armafit_frontend17MainFlutterWindow")
